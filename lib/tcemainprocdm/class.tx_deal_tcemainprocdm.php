 ...
 *
 *
 *   66: class tx_deal_tcemainprocdm
 *
 ...
 */
  ...
  {
      // Require map library
    require_once( PATH_typo3conf . 'ext/deal/lib/tcemainprocdm/marketplaces/class.tx_deal_ebayApi.php' );
      // Create object
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/deal/lib/tcemainprocdm/class.tx_deal_tcemainprocdm.php']) {
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/deal/lib/tcemainprocdm/class.tx_deal_tcemainprocdm.php']);
}
