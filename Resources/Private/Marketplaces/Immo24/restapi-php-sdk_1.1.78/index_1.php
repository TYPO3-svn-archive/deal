...
// 150701, dwildt, 5+
$sImmobilienScout24Key = 'leg-immobilienKey';
$sImmobilienScout24Secret = 'eQ6dbRtEp1kahJPV';
$sTable = 'tx_deal_immo24certificate';
$sMode = 'live';
$sUsername = 'leg-immo';
$sUsername = 'me';
$iScoutId = 0;
// 150721, dwildt, 5+
$sImmobilienScout24Key = 'testzugang-die-netzmacherKey';
$sImmobilienScout24Secret = '8KbN2PsjTnTbRgCN';
$sTable = 'tx_deal_immo24certificateSandbox';
$sMode = 'sandbox';
$sUsername = 'test-die-netzmacher';
$iScoutId = 63598036;
$iExternalId = 11283;
$iContactId = 64613615;
...
// 150701, dwildt, 1+
$oImmocaster->setRequestUrl( $sMode );
...
//$aParameter = array('username'=>$sUsername);
...
$aParameter = array('exposeid'=>$iScoutId); // Expose-ID hinterlegen
$res        = $oImmocaster->getExpose($aParameter);
$res = json_decode($res);
echo '<div class="codebox"><pre>';
var_dump( $res );
echo '<pre></div>';
...
// 150701, dwildt, 1+
$sCertifyURL = 'http://typo3_62.4.local/typo3conf/ext/deal/Resources/Private/Marketplaces/Immo24/restapi-php-sdk_1.1.78/index_1.php'; // Komplette URL inkl. Parameter auf der das Script eingebunden wird
...
// 150701, dwildt, 1+
$aParameter = array( 'username' => $sUsername ); // Username hinterlegen (standardmäßig ihr Nutzername, der beim Login verwendet wird)
$res = $oImmocaster->getLogo( $aParameter );
echo '<div class="codebox">' . $res . '</div>';
//
///**
...
$aParameter = array(
  'username' => 'me',
  'username' => $sUsername, // 150721, dwildt, 1+
  'exposeid' => $iScoutId,
...
<realestates:apartmentRent xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:realestates="http://rest.immobilienscout24.de/schema/offer/realestates/1.0">
  <externalId>' . $iExternalId . '</externalId>
...
/*
  ...
  '<?xml version="1.0" encoding="UTF-8"?>
<common:realtorContactDetail xmlns:common="http://rest.immobilienscout24.de/schema/common/1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ns4="http://rest.immobilienscout24.de/schema/customer/1.0" xmlns:ns5="http://rest.immobilienscout24.de/schema/user/1.0" >
  <email>Anke.Rackow@LEG-Thueringen.de</email>

  <firstname>Rackow, Anke LEG</firstname>
  <lastname>Rackow, Anke LEG</lastname>
  <faxNumberCountryCode>0361 5603-324</faxNumberCountryCode>
  <faxNumberAreaCode>0361 5603-324</faxNumberAreaCode>
  <faxNumberSubscriber>0361 5603-324</faxNumberSubscriber>
  <phoneNumberCountryCode>0361 5603-602</phoneNumberCountryCode>
  <phoneNumberAreaCode>0361 5603-602</phoneNumberAreaCode>
  <phoneNumberSubscriber>0361 5603-602</phoneNumberSubscriber>

  <address>
    <city>Erfurt</city>
    <houseNumber>Mainzerhofstraße 12</houseNumber>
    <postcode>99084</postcode>
    <street>Mainzerhofstraße 12</street>
  </address>
  <countryCode>276</countryCode>


  <company>LEG Thüringen</company>
  <homepageUrl>www.leg-thueringen.de</homepageUrl>

  <defaultContact>false</defaultContact>

  <businessCardContact>false</businessCardContact>
  <externalId>781</externalId>
</common:realtorContactDetail>',
  'xml' =>
  '<?xml version="1.0" encoding="UTF-8"?>
<common:realtorContactDetail xmlns:common="http://rest.immobilienscout24.de/schema/common/1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ns4="http://rest.immobilienscout24.de/schema/customer/1.0" xmlns:ns5="http://rest.immobilienscout24.de/schema/user/1.0" >
...
<lastname>Rackow</lastname>
<faxNumberCountryCode>+49</faxNumberCountryCode>
<faxNumberAreaCode>361</faxNumberAreaCode>
<faxNumberSubscriber>5603324</faxNumberSubscriber>
<phoneNumberCountryCode>+49</phoneNumberCountryCode>
<phoneNumberAreaCode>361</phoneNumberAreaCode>
<phoneNumberSubscriber>5603602</phoneNumberSubscriber>
<address>
<street>Mainzerhofstraße</street>
<houseNumber>12</houseNumber>
<postcode>99084</postcode>
<city>Erfurt</city>
</address>
<countryCode>DEU</countryCode>
<homepageUrl>http://www.leg-thueringen.de</homepageUrl>
<defaultContact>false</defaultContact>
<businessCardContact>false</businessCardContact>
<externalId>781</externalId>
</common:realtorContactDetail>',
...
echo '<div class="codebox"><pre>';
var_dump (__METHOD__, __LINE__, json_decode($res));
echo '</pre></div>';
*/
...
$aParameter = array(
  'username'=>$sUsername,
  'contactid'=>$iContactId /*id oder externalId*/
  );
