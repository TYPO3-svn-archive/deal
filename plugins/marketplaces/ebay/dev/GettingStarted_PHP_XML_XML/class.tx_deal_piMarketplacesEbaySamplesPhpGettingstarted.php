...
class tx_deal_piMarketplacesEbaySamplesPhpGettingstarted extends tslib_pibase
{
  ...
  public $scriptRelPath = 'plugins/marketplaces/ebay/dev/GettingStarted_PHP_XML_XML/class.tx_deal_piMarketplacesEbaySamplesPhpGettingstarted.php';
  public $extKey = 'deal';
  ...
  private function ebaySampleStart()
  {
    ...
    $xmlfilter = $this->buildXMLFilter($filterarray);
    ...
    if ($resp->ack != "Success")
    {
      ...
      $results = '<h2 style="color:red;">
          ' . $this->pi_getLL('promptErrorHeader') . '
        </h2>
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/deal/plugins/marketplaces/ebay/dev/GettingStarted_PHP_XML_XML/class.tx_deal_piMarketplacesEbaySamplesPhpGettingstarted.php'])
{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/deal/plugins/marketplaces/ebay/dev/GettingStarted_PHP_XML_XML/class.tx_deal_piMarketplacesEbaySamplesPhpGettingstarted.php']);
}
